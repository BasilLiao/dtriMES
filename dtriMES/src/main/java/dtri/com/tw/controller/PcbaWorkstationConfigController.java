...
import dtri.com.tw.service.PcbaWorkstationConfigService;

@Controller
public class PcbaWorkstationConfigController extends AbstractController {
	public PcbaWorkstationConfigController() {
		super("pcba_workstation_config.basil");
	}

	@Autowired
	PackageService packageService;
	@Autowired
	PcbaWorkstationConfigService configService;

	/**
	 * 訪問
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_workstation_config.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_workstation_config.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_workstation_config.basil.AC" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_workstation_config.basil.AU" }, method = { RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_workstation_config.basil.AD" }, method = { RequestMethod.DELETE }, produces = "application/json;charset=UTF-8")
