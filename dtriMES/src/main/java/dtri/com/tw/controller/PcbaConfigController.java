...
import dtri.com.tw.service.PcbaConfigService;

@Controller
public class PcbaConfigController extends AbstractController {
	public PcbaConfigController() {
		super("pcba_config.basil");// 功能
	}

	@Autowired
	PackageService packageService;
	@Autowired
	PcbaConfigService configService;

	/**
	 * 訪問
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_config.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_config.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_config.basil.AC" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_config.basil.AU" }, method = { RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_config.basil.AD" }, method = { RequestMethod.DELETE }, produces = "application/json;charset=UTF-8")
