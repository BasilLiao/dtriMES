...
import dtri.com.tw.service.PcbaRuleSnService;

@Controller
public class PcbaRuleSnController extends AbstractController {
	public PcbaRuleSnController() {
		super("pcba_rule_sn.basil");// 功能
	}

	@Autowired
	PackageService packageService;
	@Autowired
	PcbaRuleSnService configService;

	/**
	 * 訪問
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_rule_sn.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_rule_sn.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_rule_sn.basil.AC" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_rule_sn.basil.AU" }, method = { RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/pcba_rule_sn.basil.AD" }, method = { RequestMethod.DELETE }, produces = "application/json;charset=UTF-8")
