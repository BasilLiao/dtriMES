...
public class RepairListController extends AbstractController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.AC" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.AU" }, method = { RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.AD" }, method = { RequestMethod.DELETE }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.S1" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/ajax/repair_list.basil.S2" }, method = { RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
