...
@Repository
public interface PcbaHeaderDao extends JpaRepository<PcbaHeader, Long> {

	// 查詢全部
	List<PcbaHeader> findAll();

//	// 查詢最新一筆的製令單關聯
//	PcbaHeader findTopByPhpbgidOrderBySysmdateDesc(Long phpbgid);
...
//	List<PcbaHeader> findAllByProductionHeader(//
...
//
	// 查詢重複製令
	List<PcbaHeader> findAllByPhprid(String phprid);
	
//	
//	// 查詢重複製令
//	List<PcbaHeader> findAllByProductionRecordsAndPhtype(ProductionRecords phprid, String Phtype);
//
//	// 查詢重複製令+排除狀態
//	List<PcbaHeader> findAllByProductionRecordsAndSysstatusNotIn(ProductionRecords phprid,
//			List<Integer> sysstatus);
//
//	// 排除狀態
//	List<PcbaHeader> findAllBySysstatusNotIn(List<Integer> sysstatus);
//
//	// 查詢重複製令+指定狀態
//	List<PcbaHeader> findAllByProductionRecordsAndSysstatusIn(ProductionRecords phprid, List<Integer> sysstatus);
//
//	// 查詢重複製令+ID
//	List<PcbaHeader> findAllByProductionRecordsAndPhwpid(ProductionRecords phprid, Long phwpid);
//
	// 查詢ID
	List<PcbaHeader> findAllByPhid(Long phid);
//	
//	// 查詢 Body ID
//	List<PcbaHeader> findAllByPhpbgid(Long phpbgid);
