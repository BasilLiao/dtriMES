 ...
 *      pb_sn : SN(出貨序號)目前<br>     
 *      pb_old_sn: SN(出貨序號)舊的<br>
 *      pb_b_sn:燒錄序號<br>
 *      pb_useful_sn :  SN (0=有效/1=已出貨/2=可拆解/9=已失效)   <br>
 *      pb_f_value : SN(需維修項目) (JSON 包裝)<br>
 *      pb_f_note : 損壞說明<br>      
 *      pb_w_name :過站人1-20格<br>        
 *      pb_w_p_date : 過站時間1-20格<br>        
 *      pb_value : pb_value1~50(最多50格)登記產品-項目組件名稱&序號 <br> 
 *      pb_schedule : 進度格式:[{name:A站,OK:N},{name:B站,OK:Y}] <br> 
 *      pb_check : 是否完成<br>      
 *      pb_position : 置物位置 <br>
 *      pb_w_years: 保固年份 <br>  
 ...
 * 
 */
@IdClass(PcbaBody.PrimaryKey.class)
@Entity
@Table(name = "pcba_body")
@EntityListeners(AuditingEntityListener.class)
public class PcbaBody implements Serializable {
	...
	// 功能項目
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pcba_body_seq")
	@SequenceGenerator(name = "pcba_body_seq", sequenceName = "pcba_body_seq", allocationSize = 1)
	@Column(name = "pb_id")
	private Long pbid;
